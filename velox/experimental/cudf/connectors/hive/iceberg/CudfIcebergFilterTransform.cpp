...
class InjectedColumnFilterTransformer
 ...
 private:
  ...
  std::reference_wrapper<const cudf::ast::expression> visit(
    ...
    current_ = {&transformed, wasRelaxed, requiresSplitSpecificDecimalTypes};
    return transformed;
  }
  ...
  Transformed current_{nullptr, false, false};
};
